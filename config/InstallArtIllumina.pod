...
You will want to add the C</art_bin_GreatSmokyMountains/> subdirectory of C<packages> to the C<tools> list in
your L<FIG_Config>. This puts art_illumina in the tool path. To test your installation, run the L<Config> script to
